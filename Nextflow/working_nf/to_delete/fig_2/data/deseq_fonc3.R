...
png("identite_0_1.png", width = 600, height = 400)
...
cat("Nombre de genes dans res_df :", nrow(res_df), "\n")
cat("Nombre de genes dans Aureo (translation_genes):", nrow(translation_genes), "\n")
cat("Nombre de genes dans sub :", nrow(sub), "\n\n")

cat("---- EXEMPLES GeneID DESeq2 ----\n")
print(head(res_df$GeneID, 20))

cat("\n---- EXEMPLES GeneID AUREO ----\n")
print(head(translation_genes$GeneID, 20))

cat("\n---- Résumé baseMean ----\n")
print(summary(sub$baseMean))

cat("\n---- Quelques lignes de sub ----\n")
print(head(sub))
